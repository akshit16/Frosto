...
<!-- Mirrored from demo.designshopify.com/html_lavie/lavie_resturant/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2016 17:59:27 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Frosto|| Login</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-xs-12">
                <form action="userlogin.php" class="login-side" method="post">
					<div class="login-reg">
						<h3>Login</h3>
            ...
            <div class="col-sm-6 col-xs-12 lr2">
              ...
              <div class="login-reg">
				...
				<div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter your Name" value="" name="name">
                </div>
				<div class="form-group">
                    <label class="control-label">Username</label>
                    <input type="text" class="form-control" placeholder="Enter your Username" value="" name="user">
                </div>
				<div class="form-group">
                    <label class="control-label">Password</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Contact Number" value="" name="contact">
                </div>
                <div class="form-group">
                    <label class="control-label">Email</label>
                    <input type="email" class="form-control" placeholder="Email Id" value="" name="email">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Referral Code" value="" name="referal">
                </div>
                </div>
                <div class="frm-action">
                    <div class="input-box tci-box">
...
<!-- Mirrored from demo.designshopify.com/html_lavie/lavie_resturant/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2016 17:59:28 GMT -->
</html>
