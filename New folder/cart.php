                                ...
                                <table class="shop_table cart table">
                                    ...
                                    <tbody>
                                        <tr class="cart_item">
                                            ...
                                            <td class="item-price"> $13.00 </td>
                                            <td class="item-qty"> 3 </td>
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="total-price" id="total-price">$130.00</td>
                                        </tr>
                                        <tr class="cart_item">
                                            <td class="cart-action" colspan="6">
                                                ...
                                                <div class="update-cart">
                                                    ...
                                                    <div class="input-box">
                                                        <a href="orderonline.php"><button type="submit" class="btn btn-primary">Update Cart</button></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <form method="post" action="#">
                                <div class="table-responsive">
                                    ...
                                    <div class="input-box tci-box text-center">
                                        <input type="submit" class="in-btn" name="processed-checkout" value="Processed Checkout">
                                    </div>
                                </div>
                            </form>
                        </div>
