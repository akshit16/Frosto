...
<head>
    ...
    <title>Apna Dhaba || News and Promotion</title>
            ...
            <div class="slider-container">
                <div class="bread-main">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">News and Promotions</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 col-sm-8 col-xs-12">
                            ...
                            <div class="event-prodcut">
                                ...
                                <div class="ep-content text-center">
                                    <div class="ep-heading">
                                        <h1><a href="#">Aliquam Ac Varius Magna</a></h1>
                                    </div>
                                    <div class="ep-type">
                                        <ul>
                                            <li>January 5</li>
                                    ...
                                    <div class="sm-des">
                                        Vivamus interdum risus ac elementum vehicula. Duis vulputate blandit felis. In in molestie ante. Nullam pulvinar nunc sed urna viverra feugiat. Quisque a nulla elementum, faucibus urna in, convallis dolor. Proin sed turpis odio. Fusce massa urna, commodo eu sem vel, commodo luctus nisl.
                                    </div>
                        ...
                        <div class="event-paginaton text-center">
                            <ul>
