...
//echo "Deleted.";
              ...
              // echo "your order is placed";
                $oid = "update orderid set amount = '{$row["Discount"]}',email='{$ro["email"]}',contact= '{$ro["contact"]}' where user = '{$_SESSION["user"]}' and address = '{$_SESSION['add']}' and date='{$_SESSION['time']}' ";
...
$coup = "update coupon set code = 'null', discount= 0 where user='{$_SESSION['user']}'and code = '{$_SESSION['coupon']}'";
