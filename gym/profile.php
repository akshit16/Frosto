        ...
        <div class="profile">
              ...
              <div class="profile-container">
                <div class="profile-card" >
                  ...
                  <div class="profile-overview">
                    ...
                    <a href= <?php echo '"complete.php?cid='.$cid.'"'?>> <button class="profile-follow-btn" type="button">Completed</button></a>
                    <p><b>Date and Time of Order : </b> <?php echo $date;?></p>
					
					<p><b>Contact : </b><?php echo $contact;?></p>
					<p><b>Amount :</b> Rs. <?php echo $amt;?></p>
                  ...
                  <div class="profile-info">
                    <ul class="profile-nav">
                      <li>
                        ...
                        <a href="#">
                          <h3 class="profile-nav-heading">Rs. <?php echo $amt;?></h3>
                          <em>
          ...
          <div class="profile-body">
            <div class="profile-container">
				...
				<h5>Dish: </h5><table><tr><td><h4><?php echo $dish1; echo' x ';?></h4></td><td><?php  echo' <b><h4>';  echo $quantity1; echo '</h4></b>';?></h4></td></tr></table>
	            <h5>Date and time of order : </h5><h4><?php echo $date;?>  </h4>
